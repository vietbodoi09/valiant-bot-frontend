                    ...
                    {config.mode === 'grid' && (
                      <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="space-y-2">
                            <Label className="text-white/60 text-xs">Crash Stop (% drop from entry)</Label>
                            <Input type="number" min={0} max={90} step={1} value={config.grid_crash_stop_pct || 0}
                              onChange={e => setConfig({...config, grid_crash_stop_pct: Number(e.target.value)})}
                              className="bg-white/5 border-white/10 text-white" placeholder="e.g. 15 = stop if -15%" />
                          </div>
                          <div className="space-y-2">
                        ...
                        <p className="text-[10px] text-white/40">Set to 0 to disable. Crash Stop thoát khi giá dump X% từ lúc bắt đầu. Bot runs until manual stop if all are 0.</p>
